...
// CONFIGURACIÓN DE APIS (Correcto: Sin comillas para leer la variable de entorno)
        ...
        if ((cliente.pago === 'transferencia' || cliente.pago === 'mercadopago')) {
            ...
            if (!ai) {
                ...
                try {
                    ...
                    console.error("⚠️ Error en auditoría de IA (Google saturado/caído, se continúa con el pedido):", errorIA.message);
                }
            }
        }
